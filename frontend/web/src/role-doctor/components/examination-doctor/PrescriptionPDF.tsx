    ...
    try {
      ...
      const options = {
        ...
        html2canvas: {
          ...
          allowTaint: true, // Changed to true to handle cross-origin images
          logging: false,
        ...
        <div className="flex justify-between items-start mb-6 pb-4 border-b-2 border-black">
          ...
          <div className="text-right">
            ...
            <div className="text-sm mt-1">
              ...
              <div className="font-bold">{prescription?.prescriptionId || "N/A"}</div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-2">
              <div className="space-y-2">
                <div className="flex text-sm">
                  ...
                  <span>{patientInfo?.fullName || "Không xác định"}</span>
                </div>
                <div className="flex text-sm">
                  <span className="font-bold mr-2">Mã bệnh nhân:</span>
                  <span>{prescription?.patientId || "N/A"}</span>
                </div>
                <div className="flex text-sm">
              ...
              <div className="space-y-2">
                <div className="flex text-sm">
                  ...
                  <span>{patientInfo?.gender === "FEMALE" ? "Nữ" : patientInfo?.gender === "MALE" ? "Nam" : "Không xác định"}</span>
                </div>
                <div className="flex text-sm">
                ...
                <div key={detail.detailId || index} className="text-sm">
                  <div className="flex justify-between items-start font-bold mb-1">
                    <span className="flex-1">
                      ...
                      {detail.medicine?.medicineName || "Thuốc không xác định"}
                    </span>
                    <span className="ml-4">
                  ...
                  <div className="ml-6 text-gray-700">
                    {detail.frequency || ""}, {detail.prescriptionNotes || ""}, {detail.duration || ""}
                  </div>
                </div>
