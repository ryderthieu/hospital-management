  ...
  return (
    <div className="flex-1 min-h-screen bg-gray-50">
      {/* Main content */}
        <main className="p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-semibold">Danh sách bệnh nhân đặt lịch hẹn</h1>
            <p className="text-gray-500">Mặc định: Hiển thị tất cả bệnh nhân đặt lịch hẹn trong hôm nay</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
            <div className="p-4 flex flex-row gap-3 items-center border-b border-gray-200">
              <h2 className="font-semibold text-lg">Danh sách bệnh nhân đặt lịch hẹn</h2>
