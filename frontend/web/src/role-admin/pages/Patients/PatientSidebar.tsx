...
const MedicalRecordIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"></path></svg>;
...
const PaymentIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>;
...
const HealthIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>;
  ...
  return (
    <div className="w-full bg-white py-6 px-3 rounded-lg border border-gray-200">
      <div className="flex flex-col items-center">
        ...
        <p className="text-gray-500 text-sm my-1">BN001</p>
        <p className="text-gray-700 text-sm">+84 712 345 678</p>
      </div>
      ...
      <div className="mt-6 space-y-2">
        {menuItems.map((item) => (
          ...
          >
            <span className={activeTab === item.id ? 'text-base-700' : 'text-gray-500'}>
              {item.icon}
            </span>
            {item.name}
          </button>
