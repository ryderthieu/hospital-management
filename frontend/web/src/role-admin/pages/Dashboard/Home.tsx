import UpMetric from "../../components/sections/statistics/UpMetric";
import DropMetric from "../../components/sections/statistics/DropMetric";
import StatisticsChart from "../../components/sections/statistics/StatisticsChart";
import RecentTransactions from "../../components/sections/statistics/RecentTransaction";
import PageMeta from "../../components/common/PageMeta";
import { BoxCubeIcon, CalendarIcon, GroupIcon, TaskIcon } from "../../components/assets/icons";
import RecentPatients from "../../components/sections/statistics/RecentPatients";
import TodayAppointments from "../../components/sections/statistics/TodayAppointment";
    ...
    <>
      ...
      <div className="">
        <div className="col-span-12 xl:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 mb-4">
          ...
          <DropMetric title="Đặt trước" value={836} percentChange={11.64} icon={CalendarIcon} bgColor="bg-yellow-300/30" iconColor="text-yellow-500" />
