      ...
      <div className="space-y-4 ml-1">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-medium">Nguyễn Thị Phiến</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Mã bệnh nhân</p>
            <p className="font-medium">BN001</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Ngày sinh</p>
            <p className="font-medium">15/07/1978</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium">+84 712 345 678</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Email</p>
            <p className="font-medium">ntphien@gmail.com</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Địa chỉ</p>
            <p className="font-medium">123 Nguyễn Trãi, Quận 1, TP.HCM</p>
          </div>
          <div>
            <p className="text-gray-500 text-sm">Bảo hiểm y tế</p>
            <p className="font-medium">BH123456789</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="p-3 bg-gray-50 rounded-lg text-center">
              ...
              <p className="font-medium">160 cm</p>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg text-center">
              <p className="text-gray-500 text-sm">Cân nặng</p>
              <p className="font-medium">58 kg</p>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg text-center">
            ...
            <div className="p-3 bg-gray-50 rounded-lg text-center">
              ...
              <p className="font-medium">O<sup class="font-medium text-sm">+</sup></p>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg text-center">
