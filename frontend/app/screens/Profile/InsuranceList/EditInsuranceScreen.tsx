...
import type { EditInsuranceScreenRouteProp, EditInsuranceScreenNavigationProp } from "../../../navigation/types"
...
const EditInsuranceScreen: React.FC = () => {
  const navigation = useNavigation<EditInsuranceScreenNavigationProp>()
  const route = useRoute<EditInsuranceScreenRouteProp>()
  const { insurance } = route.params

  // Initialize form state from insurance
  ...
  const handleSave = () => {
    // Here you would typically save the insurance data to your backend
    // For now, we'll just navigate back
    console.log("Saving insurance data:", formState)
    navigation.goBack()
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Chỉnh sửa bảo hiểm" showBack={true} onBackPress={() => navigation.goBack()} />
      ...
      >
        <ScrollView style={styles.scrollView}>
          ...
          <Section title="Thông tin cơ bản">
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.inputLabel}>Loại bảo hiểm</Text>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.datePickerButton} onPress={() => setShowStartDatePicker(true)}>
                <Text style={styles.datePickerText}>{formState.startDate || "Chọn ngày hiệu lực"}</Text>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity style={styles.datePickerButton} onPress={() => setShowExpiryDatePicker(true)}>
                <Text style={styles.datePickerText}>{formState.expiryDate || "Chọn ngày hết hạn"}</Text>
                <Ionicons name="calendar-outline" size={20} color="#9CA3AF" />
              </TouchableOpacity>
            </View>
            ...
            <Section title="Thông tin bổ sung">
              ...
              <View style={styles.inputContainer}>
                ...
                <TouchableOpacity style={styles.datePickerButton} onPress={() => setShowLastPaymentDatePicker(true)}>
                  <Text style={styles.datePickerText}>{formState.lastPaymentDate || "Chọn ngày"}</Text>
                  <Ionicons name="calendar-outline" size={20} color="#9CA3AF" />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.inputContainer}>
                ...
                <TouchableOpacity style={styles.datePickerButton} onPress={() => setShowNextPaymentDatePicker(true)}>
                  <Text style={styles.datePickerText}>{formState.nextPaymentDate || "Chọn ngày"}</Text>
                  <Ionicons name="calendar-outline" size={20} color="#9CA3AF" />
                </TouchableOpacity>
              </View>
            </Section>
